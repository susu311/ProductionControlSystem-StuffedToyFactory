...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(FormJobDelivery))
        ...
        Me.ButtonSave.Size = New System.Drawing.Size(72, 56)
        ...
        'GroupBox3
        '
        Me.GroupBox3.Controls.Add(Me.TextBoxConfirmedDate)
        Me.GroupBox3.Controls.Add(Me.TextBoxOrderDate)
        Me.GroupBox3.Controls.Add(Me.LabelOrderDate)
        Me.GroupBox3.Controls.Add(Me.ComboBoxJobNo)
        Me.GroupBox3.Controls.Add(Me.LabelOrderID)
        Me.GroupBox3.Controls.Add(Me.DateTimePickerDeliveryDate)
        ...
        Me.GroupBox3.Controls.Add(Me.LabelDeliveryDate)
        ...
        Me.GroupBox3.Size = New System.Drawing.Size(352, 173)
        ...
        Me.TextBoxConfirmedDate.Location = New System.Drawing.Point(136, 112)
        Me.TextBoxConfirmedDate.Name = "TextBoxConfirmedDate"
        Me.TextBoxConfirmedDate.Size = New System.Drawing.Size(200, 20)
        Me.TextBoxConfirmedDate.TabIndex = 46
        '
        'TextBoxOrderDate
        '
        ...
        Me.ComboBoxJobNo.Location = New System.Drawing.Point(136, 16)
        Me.ComboBoxJobNo.Name = "ComboBoxJobNo"
        Me.ComboBoxJobNo.Size = New System.Drawing.Size(200, 21)
        Me.ComboBoxJobNo.TabIndex = 43
        '
        'LabelOrderID
        '
        ...
        '
        Me.DateTimePickerDeliveryDate.Location = New System.Drawing.Point(136, 144)
        Me.DateTimePickerDeliveryDate.Name = "DateTimePickerDeliveryDate"
        Me.DateTimePickerDeliveryDate.TabIndex = 41
        '
        'TextBoxOrderID
        '
        ...
        Me.TextBoxOrderID.Location = New System.Drawing.Point(136, 48)
        Me.TextBoxOrderID.Name = "TextBoxOrderID"
        Me.TextBoxOrderID.Size = New System.Drawing.Size(192, 20)
...
#End Region
    ...
    Private Sub FormJobConfirmation_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
            ...
            TextBoxOrderID.Text = vbNullString
    ...
    Private Sub ButtonSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ButtonSave.Click
        Try
            If ComboBoxJobNo.Text.Trim.Length <= 0 Then
                MsgBox("Job must fill Job ID.", MsgBoxStyle.Information, AppTitle)
                ComboBoxJobNo.Focus()
            ElseIf DateDiff(DateInterval.Day, DateTimePickerDeliveryDate.Value, CDate(TextBoxConfirmedDate.Text)) > 0 Then
                MsgBox("Delivery Date must be later than Order Confirmed date.", MsgBoxStyle.Information, AppTitle)
                DateTimePickerDeliveryDate.Focus()
            Else
                SavingData("Update Jobs set DeliveryDate='" & DateTimePickerDeliveryDate.Value.ToShortDateString & "' Where JobNo=" & ComboBoxJobNo.Text, False)
    ...
    Private Sub ComboBoxJobNo_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ComboBoxJobNo.SelectedIndexChanged
        Try
            If ComboBoxJobNo.SelectedIndex >= 0 And ComboBoxJobNo.Text <> "System.Data.DataRowView" Then
                Dim DataSetData As New DataSet
                Dim OleDbAdapter As New OleDb.OleDbDataAdapter("SELECT Distinct OrderID, OrderDate, ConfirmedDate, CustomerID, CustomerName, CompanyName, Address, SaleType FROM VIEWJobs WHERE JobNo = " & Val(ComboBoxJobNo.Text), sqlString)
                OleDbAdapter.Fill(DataSetData, "ViewOrders")
                With DataSetData
                    If .Tables(0).Rows.Count <= 0 Then
                        MsgBox("JOB not found.", MsgBoxStyle.Information, AppTitle)
                        ComboBoxJobNo.Focus()
                    Else
                        TextBoxOrderID.Text = .Tables(0).Rows(0).Item(0)
                        TextBoxOrderDate.Text = FormatDateTime(.Tables(0).Rows(0).Item(1), DateFormat.ShortDate)
                        TextBoxConfirmedDate.Text = .Tables(0).Rows(0).Item(2)
                        TextBoxCustomerID.Text = .Tables(0).Rows(0).Item(3)
                        TextBoxCustomerName.Text = .Tables(0).Rows(0).Item(4)
                        TextBoxCompanyName.Text = .Tables(0).Rows(0).Item(5)
                        TextBoxAddress.Text = .Tables(0).Rows(0).Item(6)
                        TextBoxSaleType.Text = .Tables(0).Rows(0).Item(7)
                        setGridData(DataGridData, "SELECT DesignNo, DesignName, SampleWidth, SampleHeight, Qty, UnitPrice, Amount FROM VIEWJobs WHERE JobNo =" & ComboBoxJobNo.Text & " ORDER BY DesignNo")
                    End If
                End With
                DataSetData.Dispose()
