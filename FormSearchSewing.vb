...
#Region " Windows Form Designer generated code "
    ...
    Friend WithEvents DataGridSearchSewing As System.Windows.Forms.DataGrid
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(FormSearchSewing))
        ...
        Me.DataGridSearchSewing = New System.Windows.Forms.DataGrid
        ...
        CType(Me.DataGridSearchSewing, System.ComponentModel.ISupportInitialize).BeginInit()
        Me.GroupBox1.SuspendLayout()
        Me.SuspendLayout()
        '
        'CheckBoxSearchWithDate
        '
        Me.CheckBoxSearchWithDate.Location = New System.Drawing.Point(32, 0)
        ...
        'ComboBoxDesignNo
        '
        Me.ComboBoxDesignNo.Location = New System.Drawing.Point(464, 24)
        ...
        'ComboBoxEmployeeID
        '
        Me.ComboBoxEmployeeID.Location = New System.Drawing.Point(464, 56)
        ...
        '
        'DataGridSearchSewing
        '
        Me.DataGridSearchSewing.BackgroundColor = System.Drawing.Color.White
        Me.DataGridSearchSewing.CaptionBackColor = System.Drawing.Color.DarkBlue
        Me.DataGridSearchSewing.CaptionForeColor = System.Drawing.Color.White
        Me.DataGridSearchSewing.CaptionText = "Sewing Info:"
        Me.DataGridSearchSewing.DataMember = ""
        Me.DataGridSearchSewing.Enabled = False
        Me.DataGridSearchSewing.GridLineColor = System.Drawing.Color.Black
        Me.DataGridSearchSewing.HeaderForeColor = System.Drawing.SystemColors.ControlText
        Me.DataGridSearchSewing.Location = New System.Drawing.Point(8, 176)
        Me.DataGridSearchSewing.Name = "DataGridSearchSewing"
        Me.DataGridSearchSewing.ReadOnly = True
        Me.DataGridSearchSewing.Size = New System.Drawing.Size(728, 376)
        Me.DataGridSearchSewing.TabIndex = 95
        '
        'CheckBoxDesignNo
        '
        Me.CheckBoxDesignNo.Location = New System.Drawing.Point(376, 24)
        ...
        'CheckBoxEmployeeID
        '
        Me.CheckBoxEmployeeID.Location = New System.Drawing.Point(376, 56)
        ...
        'DateTimePickerTo
        '
        Me.DateTimePickerTo.Location = New System.Drawing.Point(92, 48)
        Me.DateTimePickerTo.Name = "DateTimePickerTo"
        Me.DateTimePickerTo.Size = New System.Drawing.Size(172, 20)
        ...
        'DateTimePickerfrom
        '
        Me.DateTimePickerfrom.Location = New System.Drawing.Point(92, 24)
        Me.DateTimePickerfrom.Name = "DateTimePickerfrom"
        Me.DateTimePickerfrom.Size = New System.Drawing.Size(172, 20)
        ...
        Me.Controls.Add(Me.DataGridSearchSewing)
        Me.Controls.Add(Me.CheckBoxDesignNo)
        Me.Controls.Add(Me.CheckBoxEmployeeID)
        Me.ForeColor = System.Drawing.Color.DarkBlue
        Me.Name = "FormSearchSewing"
        Me.StartPosition = System.Windows.Forms.FormStartPosition.CenterParent
        Me.Text = "Search Sewing"
        Me.Groupbuttons.ResumeLayout(False)
        CType(Me.DataGridSearchSewing, System.ComponentModel.ISupportInitialize).EndInit()
...
#End Region
    ...
    Private Sub FormSearchSewing_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        setGridData(DataGridSearchSewing, "Select DesignNo,DesignName, EmployeeID, EmployeeName, SewingDate, QualifiedQty, RejectedQty, Status from VIEWSewing Where DesignNo<0 Order By DesignNo")
    ...
    Private Sub ButtonSearch_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ButtonSearch.Click
        Try
            Dim SQL As String = "Select Distinct DesignNo,DesignName, EmployeeID,EmployeeName, SewingDate, QualifiedQty, RejectedQty, Status from VIEWSewing"
                Search = ""
                ...
                setGridData(DataGridSearchSewing, SQL & Search & " Order By DesignNo")
            If getGridRowsCount(DataGridSearchSewing) <= 0 Then
    ...
    Private Sub ButtonListAll_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ButtonListAll.Click
        Try
            Dim SQL As String = "Select Distinct DesignNo, DesignName, EmployeeID, EmployeeName, SewingDate, Qualifiedqty, RejectedQty, Status from VIEWSewing"
            setGridData(DataGridSearchSewing, SQL & " Order By DesignNo")
        Catch ex As Exception
            MsgBox(ex.ToString, MsgBoxStyle.Information, AppTitle)
        End Try
    End Sub
    ...
    Private Sub ButtonClear_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ButtonClear.Click
        ...
        DateTimePickerfrom.Enabled = CheckBoxSearchWithDate.Checked
        DateTimePickerTo.Enabled = CheckBoxSearchWithDate.Checked
        setGridData(DataGridSearchSewing, "Select DesignNo, EmployeeID, SewingDate, QualifiedQty,RejectedQty,Status from VIEWSewing Where EmployeeID<-1 and DesignNo<=-1")
        ComboBoxDesignNo.SelectedIndex = -1
        ComboBoxEmployeeID.SelectedIndex = -1
        CheckBoxDesignNo.Checked = False
        CheckBoxEmployeeID.Checked = False
    ...
    Private Sub ButtonPrintPreview_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles ButtonPrintPreview.Click
        If getGridRowsCount(DataGridSearchSewing) > 0 Then PrintData()
    End Sub
    Private Sub PrintData()
        Try
            Dim f_report As New FormReportViewer
            Dim rptReport As New CrystalReportSearchSewing
            ...
            If CheckBoxDesignNo.Checked = True Then SelectionFormula = "{VIEWSewing.DesignNo}=" & Val(ComboBoxDesignNo.SelectedValue)
            If CheckBoxEmployeeID.Checked = True Then SelectionFormula = "{VIEWSewing.EmployeeID}=" & Val(ComboBoxEmployeeID.SelectedValue)
            If CheckBoxSearchWithDate.Checked = True Then SelectionFormula = SelectionFormula & IIf(SelectionFormula.Length > 0, " And ", "") & "{VIEWSewing.SewingDate}>=#" & SQLDateTime(DateTimePickerfrom.Value, Main.SQLDType.sqlDateOnly, True) & "# and {VIEWSewing.SewingDate}<=#" & SQLDateTime(DateTimePickerTo.Value, Main.SQLDType.sqlDateOnly, True) & "#"
