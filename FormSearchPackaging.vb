Public Class FormSearchPackaging
...
#Region " Windows Form Designer generated code "
    ...
    Friend WithEvents DataGridSearchPackaging As System.Windows.Forms.DataGrid
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(FormSearchPackaging))
        ...
        Me.DataGridSearchPackaging = New System.Windows.Forms.DataGrid
        ...
        Me.ButtonSearch.Location = New System.Drawing.Point(216, 16)
        ...
        '
        'DataGridSearchPackaging
        '
        Me.DataGridSearchPackaging.BackgroundColor = System.Drawing.Color.White
        Me.DataGridSearchPackaging.CaptionBackColor = System.Drawing.Color.DarkBlue
        Me.DataGridSearchPackaging.CaptionForeColor = System.Drawing.Color.White
        Me.DataGridSearchPackaging.CaptionText = "Packaging Info:"
        Me.DataGridSearchPackaging.DataMember = ""
        Me.DataGridSearchPackaging.GridLineColor = System.Drawing.Color.Black
        Me.DataGridSearchPackaging.HeaderForeColor = System.Drawing.SystemColors.ControlText
        Me.DataGridSearchPackaging.Location = New System.Drawing.Point(8, 176)
        Me.DataGridSearchPackaging.Name = "DataGridSearchPackaging"
        Me.DataGridSearchPackaging.ReadOnly = True
        Me.DataGridSearchPackaging.Size = New System.Drawing.Size(776, 384)
        Me.DataGridSearchPackaging.TabIndex = 95
        '
        'CheckBoxDesignNo
        '
        Me.CheckBoxDesignNo.Location = New System.Drawing.Point(400, 24)
        Me.CheckBoxDesignNo.Name = "CheckBoxDesignNo"
        Me.CheckBoxDesignNo.Size = New System.Drawing.Size(88, 16)
        Me.CheckBoxDesignNo.TabIndex = 106
        Me.CheckBoxDesignNo.Text = "DesignNo"
        '
        'CheckBoxEmployeeID
        '
        Me.CheckBoxEmployeeID.Location = New System.Drawing.Point(400, 56)
        Me.CheckBoxEmployeeID.Name = "CheckBoxEmployeeID"
        Me.CheckBoxEmployeeID.Size = New System.Drawing.Size(88, 16)
        Me.CheckBoxEmployeeID.TabIndex = 107
        ...
        Me.GroupBox1.Size = New System.Drawing.Size(320, 72)
        Me.GroupBox1.TabIndex = 108
        Me.GroupBox1.TabStop = False
        '
        'DateTimePickerTo
        '
        Me.DateTimePickerTo.Location = New System.Drawing.Point(80, 40)
        Me.DateTimePickerTo.Name = "DateTimePickerTo"
        Me.DateTimePickerTo.Size = New System.Drawing.Size(216, 20)
        ...
        'DateTimePickerfrom
        '
        Me.DateTimePickerfrom.Location = New System.Drawing.Point(80, 16)
        Me.DateTimePickerfrom.Name = "DateTimePickerfrom"
        Me.DateTimePickerfrom.Size = New System.Drawing.Size(216, 20)
        Me.DateTimePickerfrom.TabIndex = 103
        ...
        Me.Labelfrom.Location = New System.Drawing.Point(32, 16)
        Me.Labelfrom.Name = "Labelfrom"
        Me.Labelfrom.Size = New System.Drawing.Size(40, 16)
        Me.Labelfrom.TabIndex = 104
        ...
        Me.Controls.Add(Me.DataGridSearchPackaging)
        Me.Controls.Add(Me.CheckBoxDesignNo)
        Me.Controls.Add(Me.CheckBoxEmployeeID)
        Me.ForeColor = System.Drawing.Color.DarkBlue
        Me.Name = "FormSearchPackaging"
        Me.StartPosition = System.Windows.Forms.FormStartPosition.CenterParent
        Me.Text = "Search Packaging"
        Me.Groupbuttons.ResumeLayout(False)
        CType(Me.DataGridSearchPackaging, System.ComponentModel.ISupportInitialize).EndInit()
...
#End Region
    ...
    Private Sub FormSearchPackaging_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        setGridData(DataGridSearchPackaging, "Select DesignNo, DesignName, EmployeeID, EmployeeName, PackagingDate, PackagingQty, RejectedQty from VIEWPackagings Where DesignNo<0 Order By DesignNo")
    ...
    Private Sub ButtonSearch_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ButtonSearch.Click
        Try
            Dim SQL As String = "Select Distinct DesignNo,DesignName, EmployeeID,EmployeeName, PackagingDate, PackagingQty, RejectedQty from VIEWPackagings"
            Search = ""
            ...
            If CheckBoxSearchWithDate.Checked = True Then Search = Search & IIf(Search.Length > 0, " And ", " Where ") & "SewingDate Between '" & SQLDateTime(DateTimePickerfrom.Value, Main.SQLDType.sqlDateOnly, True) & "' and '" & SQLDateTime(DateTimePickerTo.Value, Main.SQLDType.sqlDateOnly, True) & "'"
            setGridData(DataGridSearchPackaging, SQL & Search & " Order By DesignNo")
            If getGridRowsCount(DataGridSearchPackaging) <= 0 Then
    ...
    Private Sub CheckBoxSearchWithDate_CheckedChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles CheckBoxSearchWithDate.CheckedChanged
        DateTimePickerfrom.Enabled = CheckBoxSearchWithDate.Checked
        DateTimePickerTo.Enabled = CheckBoxSearchWithDate.Checked
    End Sub
    ...
    Private Sub ButtonListAll_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ButtonListAll.Click
        Try
            Dim SQL As String = "Select Distinct DesignNo, DesignName, EmployeeID, EmployeeName, PackagingDate, PackagingQty, RejectedQty from VIEWPackagings"
            setGridData(DataGridSearchPackaging, SQL & " Order By DesignNo")
            ' setGridData(DataGridSearchPackaging, "Select DesignNo,DesignName, EmployeeID,EmployeeName, PackagingDate,PackagingQty, RejectedQty from VIEWPackagings")
        Catch ex As Exception
            MsgBox(ex.ToString, MsgBoxStyle.Information, AppTitle)
        End Try
    End Sub
    ...
    Private Sub ButtonClear_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ButtonClear.Click
        ...
        DateTimePickerfrom.Enabled = CheckBoxSearchWithDate.Checked
        DateTimePickerTo.Enabled = CheckBoxSearchWithDate.Checked
        setGridData(DataGridSearchPackaging, "Select DesignNo, EmployeeID, PackagingDate, PackagingQty,RejectedQty from VIEWPackagings Where EmployeeID<-1 and DesignNo<=-1")
        CheckBoxDesignNo.Checked = False
        CheckBoxEmployeeID.Checked = False
        ComboBoxDesignNo.SelectedIndex = -1
        ComboBoxEmployeeID.SelectedIndex = -1
    ...
    Private Sub ButtonPrintPreview_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ButtonPrintPreview.Click
        If getGridRowsCount(DataGridSearchPackaging) > 0 Then PrintData()
    End Sub
    Private Sub PrintData()
        Try
            Dim f_report As New FormReportViewer
            Dim rptReport As New CrystalReportSearchPackaging
            ...
            If CheckBoxDesignNo.Checked = True Then SelectionFormula = "{VIEWPackagings.DesignNo}=" & Val(ComboBoxDesignNo.SelectedValue)
            If CheckBoxEmployeeID.Checked = True Then SelectionFormula = "{VIEWPackagings.EmployeeID}=" & Val(ComboBoxEmployeeID.SelectedValue)
            If CheckBoxSearchWithDate.Checked = True Then SelectionFormula = SelectionFormula & IIf(SelectionFormula.Length > 0, " And ", "") & "{VIEWPackagings.PackagingDate}>=#" & SQLDateTime(DateTimePickerfrom.Value, Main.SQLDType.sqlDateOnly, True) & "# and {VIEWPackagings.PackagingDate}<=#" & SQLDateTime(DateTimePickerTo.Value, Main.SQLDType.sqlDateOnly, True) & "#"
