...
Public Class CrystalReportSearchCutting
    ...
    Public Overrides Property ResourceName As String
        Get
            Return "CrystalReportSearchCutting.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrystalReportSearchCutting
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrystalReportSearchCutting = New CrystalReportSearchCutting
        rpt.Site = Me.Site
        Return rpt
    End Function
