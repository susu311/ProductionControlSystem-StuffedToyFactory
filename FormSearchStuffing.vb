Public Class FormSearchStuffing
...
#Region " Windows Form Designer generated code "
    ...
    Friend WithEvents DataGridSearchStuffing As System.Windows.Forms.DataGrid
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(FormSearchStuffing))
        ...
        Me.DataGridSearchStuffing = New System.Windows.Forms.DataGrid
        ...
        CType(Me.DataGridSearchStuffing, System.ComponentModel.ISupportInitialize).BeginInit()
        ...
        'ComboBoxDesignNo
        '
        Me.ComboBoxDesignNo.Location = New System.Drawing.Point(448, 32)
        ...
        'ComboBoxEmployeeID
        '
        Me.ComboBoxEmployeeID.Location = New System.Drawing.Point(448, 72)
        ...
        Me.Groupbuttons.Location = New System.Drawing.Point(104, 96)
        ...
        '
        'DataGridSearchStuffing
        '
        Me.DataGridSearchStuffing.BackgroundColor = System.Drawing.Color.White
        Me.DataGridSearchStuffing.CaptionBackColor = System.Drawing.Color.DarkBlue
        Me.DataGridSearchStuffing.CaptionForeColor = System.Drawing.Color.White
        Me.DataGridSearchStuffing.CaptionText = "Stuffing Info:"
        Me.DataGridSearchStuffing.DataMember = ""
        Me.DataGridSearchStuffing.GridLineColor = System.Drawing.Color.Black
        Me.DataGridSearchStuffing.HeaderForeColor = System.Drawing.SystemColors.ControlText
        Me.DataGridSearchStuffing.Location = New System.Drawing.Point(8, 184)
        Me.DataGridSearchStuffing.Name = "DataGridSearchStuffing"
        Me.DataGridSearchStuffing.ReadOnly = True
        Me.DataGridSearchStuffing.Size = New System.Drawing.Size(736, 392)
        Me.DataGridSearchStuffing.TabIndex = 95
        '
        'CheckBoxDesignNo
        '
        Me.CheckBoxDesignNo.Location = New System.Drawing.Point(352, 32)
        ...
        'CheckBoxEmployeeID
        '
        Me.CheckBoxEmployeeID.Location = New System.Drawing.Point(352, 72)
        ...
        'DateTimePickerTo
        '
        Me.DateTimePickerTo.Location = New System.Drawing.Point(80, 48)
        Me.DateTimePickerTo.Name = "DateTimePickerTo"
        Me.DateTimePickerTo.Size = New System.Drawing.Size(192, 20)
        ...
        Me.DateTimePickerfrom.Size = New System.Drawing.Size(192, 20)
        ...
        Me.Controls.Add(Me.DataGridSearchStuffing)
        Me.Controls.Add(Me.CheckBoxDesignNo)
        Me.Controls.Add(Me.CheckBoxEmployeeID)
        Me.Controls.Add(Me.GroupBox1)
        Me.ForeColor = System.Drawing.Color.DarkBlue
        Me.Name = "FormSearchStuffing"
        Me.StartPosition = System.Windows.Forms.FormStartPosition.CenterParent
        Me.Text = "Search Stuffing"
        Me.Groupbuttons.ResumeLayout(False)
        CType(Me.DataGridSearchStuffing, System.ComponentModel.ISupportInitialize).EndInit()
...
#End Region
    ...
    Private Sub FormSearchStuffing_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        setGridData(DataGridSearchStuffing, "Select DesignNo, DesignName,EmployeeID,EmployeeName, StuffingDate,QualifiedQty, RejectedQty, Status from VIEWStuffings Where DesignNo<0 Order By DesignNo")
    ...
    Private Sub ButtonSearch_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ButtonSearch.Click
        Try
            Dim SQL As String = "Select Distinct DesignNo,DesignName, EmployeeID,EmployeeName, StuffingDate, QualifiedQty, RejectedQty, Status from VIEWStuffings"
                Search = ""
                ...
                If CheckBoxSearchWithDate.Checked = True Then Search = Search & IIf(Search.Length > 0, " And ", " Where ") & "StuffingDate Between '" & SQLDateTime(DateTimePickerfrom.Value, Main.SQLDType.sqlDateOnly, True) & "' and '" & SQLDateTime(DateTimePickerTo.Value, Main.SQLDType.sqlDateOnly, True) & "'"
                setGridData(DataGridSearchStuffing, SQL & Search & " Order By DesignNo")
            If getGridRowsCount(DataGridSearchStuffing) <= 0 Then
    ...
    Private Sub ButtonListAll_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ButtonListAll.Click
        Try
            Dim SQL As String = "Select Distinct DesignNo, DesignName, EmployeeID, EmployeeName, StuffingDate, QualifiedQty, RejectedQty, Status from VIEWStuffings"
            setGridData(DataGridSearchStuffing, SQL & " Order By DesignNo")
        Catch ex As Exception
            MsgBox(ex.ToString, MsgBoxStyle.Information, AppTitle)
        End Try
    End Sub
    ...
    Private Sub ButtonClear_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ButtonClear.Click
        ...
        DateTimePickerfrom.Enabled = CheckBoxSearchWithDate.Checked
        DateTimePickerTo.Enabled = CheckBoxSearchWithDate.Checked
        setGridData(DataGridSearchStuffing, "Select DesignNo, EmployeeID, StuffingDate, QualifiedQty,RejectedQty,Status from VIEWStuffings Where EmployeeID<-1 and DesignNo<=-1")
        ComboBoxDesignNo.SelectedIndex = -1
        ComboBoxEmployeeID.SelectedIndex = -1
        CheckBoxDesignNo.Checked = False
        CheckBoxEmployeeID.Checked = False
    ...
    Private Sub ButtonPrintPreview_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ButtonPrintPreview.Click
        If getGridRowsCount(DataGridSearchStuffing) > 0 Then PrintData()
    End Sub
    Private Sub PrintData()
        Try
            Dim f_report As New FormReportViewer
            Dim rptReport As New CrystalReportSearchStuffing
            ...
            If CheckBoxDesignNo.Checked = True Then SelectionFormula = "{VIEWStuffings.DesignNo}=" & Val(ComboBoxDesignNo.SelectedValue)
            If CheckBoxEmployeeID.Checked = True Then SelectionFormula = "{VIEWStuffings.EmployeeID}=" & Val(ComboBoxEmployeeID.SelectedValue)
            If CheckBoxSearchWithDate.Checked = True Then SelectionFormula = SelectionFormula & IIf(SelectionFormula.Length > 0, " And ", "") & "{VIEWStuffings.StuffingDate}>=#" & SQLDateTime(DateTimePickerfrom.Value, Main.SQLDType.sqlDateOnly, True) & "# and {VIEWStuffings.StuffingDate}<=#" & SQLDateTime(DateTimePickerTo.Value, Main.SQLDType.sqlDateOnly, True) & "#"
